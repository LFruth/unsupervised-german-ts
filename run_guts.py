...
parser.add_argument("--model_path", type=str, default="./models/GUTS-2.bin", help="Path to a pretrained model")
parser.add_argument("--input_text", type=str, default=None, help="Paragraph as input, which should be simplified by the generator")
parser.add_argument("--top_p", type=float, default=1, help="p value for nucleus sampling")
parser.add_argument("--top_k", type=int, default=0, help="K value for top-K sampling")
parser.add_argument("--num_samples", type=int, default=1, help="Number of samples to return")
...
outputs = generator.run(input_text, top_k=args.top_k, top_p=args.top_p, sample_size=args.num_samples, temperature=args.temperature)
